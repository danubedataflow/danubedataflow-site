...
function setupForm() {
    makeForm(
        makeSlider('numTiles', 'Anzahl der Kacheln pro Achse', 1, 5, 3),
        makeSlider('lineGap', 'Distanz der Anfangspunkte', 5, 100, 50),
        makeSlider('maxMovement', 'Maximale Bewegung', 5, 20, 10),
    );
}
